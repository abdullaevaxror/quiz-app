...
class ComposerAutoloaderInit033e0ec1b3aeed68788f8e8728b1162a
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInit033e0ec1b3aeed68788f8e8728b1162a::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequire033e0ec1b3aeed68788f8e8728b1162a($fileIdentifier, $file);
        }
 ...
 * @return void
 */
function composerRequire033e0ec1b3aeed68788f8e8728b1162a($fileIdentifier, $file)
{
