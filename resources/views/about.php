        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="p-6 border rounded-lg">
                    ...
                    <p class="text-gray-600">Monitor your improvement with detailed analytics and performance
                        insights.</p>
                </div>
                <div class="p-6 border rounded-lg">
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="space-y-6 max-w-3xl mx-auto">
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <p class="text-gray-600">Simply sign up for an account, navigate to the dashboard, and click on
                        "Create
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <p class="text-gray-600">Yes, QuizApp offers a free tier with essential features. Premium features
                        are
                        available through our subscription plans.</p>
                </div>
                <div class="bg-white rounded-lg shadow-md p-6">
                    <h3 class="text-lg font-semibold mb-3">Can I share my quizzes with others?</h3>
                    <p class="text-gray-600">Yes, you can easily share your quizzes via a unique link or invite
                        participants
